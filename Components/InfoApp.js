  ...
  return (
    ...
    >
      ...
      <View style={[styles.box, { backgroundColor: theme.card }]}>
        ...
        <Text style={[styles.boxBody, { color: theme.text }]}>
          El Proyecto Ambiental Escolar es el compromiso para hacer del colegio un lugar
      ...
      <View style={[styles.box, { backgroundColor: theme.card }]}>
        ...
        <Text style={[styles.boxBody, { color: theme.text }]}>
          Cada residuo que separas de forma correcta suma puntos para el ranking de tu
          curso en el colegio.
        </Text>
      </View>

      <View style={[styles.box, { backgroundColor: theme.primary }]}>
        <Text style={[styles.boxTitle, { color: '#fff' }]}>Innovación</Text>
        <Text style={[styles.boxBody, { color: '#fff' }]}>
          Cambiamos el papel y el lápiz por una aplicación móvil para controlar nuestro
          impacto ambiental con tecnología.
        </Text>
      </View>
    </ScrollView>
  );
